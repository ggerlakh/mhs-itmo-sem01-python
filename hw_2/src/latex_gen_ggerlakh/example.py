from latex_gen_ggerlakh.convert_to_tex import generate_table, generate_tex_doc, generate_picture, convert_tex_to_pdf
...
if __name__ == "__main__":
    ...
    with open(path_to_output_tex_file, "w") as tex_file:
        ...
        print(f"write tex output to {path_to_output_tex_file}")
    convert_tex_to_pdf(path_to_output_tex_file)
    print(f"converted {path_to_output_tex_file} to {path_to_output_tex_file[:-4] + '.pdf'}")